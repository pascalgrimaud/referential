package io.github.pascalgrimaud.referential.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("referential");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("referential");
        ...
        config.getMapConfigs().put("io.github.pascalgrimaud.referential.domain.*", initializeDomainMapConfig(jHipsterProperties));
